...
function getStepContent(step) {
  switch (step) {
    case 0:
      return (<div><p>select services</p>
              <form>
                <input type='checkbox' value='webdevelopment' />
                <input type='checkbox' value='Graphic design' />
                <input type='checkbox' value='Digital Marketting' />
                <input type='checkbox' value='web Hosting' />
              </form>
            </div>)
    case 1:
      return (<div>
